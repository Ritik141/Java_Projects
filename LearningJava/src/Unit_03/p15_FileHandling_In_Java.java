...
class File_operations {
	...
	void takeInputFromAFile() throws IOException {
		...
		String path = "C:\\Users\\ROHIT SINGH\\git\\Java_Projects\\LearningJava\\src\\Unit_03\\input.txt";
...
//		}
	...
	void saveOutputIntoAFile() throws IOException {
		...
		try {
			myObj = new FileWriter("C:\\Users\\ROHIT SINGH\\git\\Java_Projects\\LearningJava\\src\\Unit_03\\output.txt");
		} catch (IOException e) {
			e.printStackTrace();
		}
	...
	void saveLogOfProgram() throws IOException {
		...
		try {
			myObj = new FileWriter("C:\\Users\\ROHIT SINGH\\git\\Java_Projects\\LearningJava\\src\\Unit_03\\log.txt",true);
		} catch (IOException e) {
			e.printStackTrace();
		}
